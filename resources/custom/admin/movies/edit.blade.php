            ...
            <div class="box-body">
              <form role="form" method="POST" action="{{ url( '/admin/update-movie' ) }}" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('runtime') ? ' has-error' : '' }}">
                    ...
                    <input id="runtime" type="text" class="form-control" name="runtime"  value="{{ ( !empty( $movie ) && !empty( $movie->runtime ) ) ? $movie->runtime : '' }}" />
                        ...
                        @if( !empty( $agerestrictions ) )
                            @foreach( $agerestrictions as $agerestriction )
                                <option value="{{ !empty( $agerestriction->id ) ? $agerestriction->id : '' }}"
                                    @if( $movie->agerestriction_id == $agerestriction->id )
                                        selected
                                    @endif
